...
|----------|---------------|
| [getting-started.md](getting-started.md) | Dev container setup, local setup, seed data, useful commands |
| [architecture.md](architecture.md) | Stack, directory structure, request flow, data model, key decisions |
| [writing-posts.md](writing-posts.md) | Markdown pattern, what gets extracted, status/scheduling, supported syntax |
